...
| Framework | Alignment |
|---|---|
| MITRE ATT&CK | `T1048` — Exfiltration Over Alternative Protocol<br>`T1537` — Transfer Data to Cloud Account<br>`T1567.002` — Exfiltration to Cloud Storage |
| NIST CSF 2.0 / SP 800-61r3 | **Detect**, **Respond**, **Recover** |
| AWS Well-Architected Security Pillar | `SEC10-BP02` — Develop incident management plans<br>`SEC10-BP03` — Prepare forensic capabilities<br>`SEC10-BP04` — Develop and test security incident response playbooks<br>`SEC10-BP06` — Pre-deploy tools |
