...
| Framework | Alignment |
|---|---|
| MITRE ATT&CK | `T1078.004` — Valid Accounts: Cloud Accounts<br>`T1098.001` — Account Manipulation: Additional Cloud Credentials<br>`T1562.008` — Impair Defenses: Disable or Modify Cloud Logs |
